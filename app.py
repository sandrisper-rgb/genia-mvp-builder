...
def add_background(path: str) -> None:
    ...
    st.markdown(
        ...
        .result-box,.maturity-card {{ background:rgba(255,255,255,.68); border-radius:18px; padding:18px; margin-top:12px; }}
...
tabs = st.tabs([
    "1. Problema", "2. Usuario y flujo", "3. Variable objetivo", "4. Datos e IA",
